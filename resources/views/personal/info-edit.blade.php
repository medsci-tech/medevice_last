...
<div class="home_card ui-form-item-link" onclick="wxChooseImage()">
    <a href="javascript:;" class="">
        ...
        <img  src="{{ $customer->head_img ? $customer->head_img.'?imageView2/1/w/75/h/75/q/90' : $customer->head_image_url }}"  class="home_card_head_img">
    </a>
</div>
<div class="m-top">
            ...
            success: function (res) {
                ...
                wx.uploadImage({
                    ...
                    success: function (res) {
                        ...
                        $(".home_card_head_img").attr("src", localIds);
                        postForm('/personal/upload',{serverId:serverId,localIds:localIds},function () {
