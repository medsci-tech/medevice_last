...
namespace {
    ...
    class Wechat extends \App\BasicShop\Wechat\Facades\Wechat{
        ...
        public static function createMenu(){
            return \App\BasicShop\Wechat\Wechat::createMenu();
        }
        ...
        public static function messageEventCallback(){
            return \App\BasicShop\Wechat\Wechat::messageEventCallback();
        }
        ...
        public static function subscribeEventCallback(){
            return \App\BasicShop\Wechat\Wechat::subscribeEventCallback();
        }
    ...
    class MessageSender extends \App\BasicShop\Message\Facades\MessageSender{
        ...
        public static function generateMessageVerify($start = 0, $end = 999999){
            return \App\BasicShop\Message\LuosimaoMessageSender::generateMessageVerify($start, $end);
        }
        ...
        public static function createMessageVerify($phone){
            return \App\BasicShop\Message\LuosimaoMessageSender::createMessageVerify($phone);
        }
